  ...
  return (
    ...
    <div className="interview-page">
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: Who is Oli Stormz?</h3>
        <p id="q1" className="interview-answer">
        ...
        <h3 className="interview-question">Q: Who are you?</h3>
        <p id="q2" className="interview-answer">
        ...
        <h3 className="interview-question">Q: Why should anyone care?</h3>
        <p id="q3" className="interview-answer">
      ...
      <h3 className="interview-question">Q: Why did you decide to interview yourself?</h3>
        <p id="q4" className="interview-answer">
          Because I was tired of sitting around waiting for someone to ask me what I have to say. 
        </p>

      <h3 className="interview-question">Q: How does your music reflect the life you’ve lived?</h3>
        <p id="q5" className="interview-answer">
...
The music is just the external echo of all that. It’s not about the art itself, it’s about what had to happen inside me for this art to even exist. That’s what you’re hearing.
        ...
        <h3 className="interview-question">Q: Do you believe in fate, or are you building it brick by brick?</h3>
        <p id="q6" className="interview-answer">
      ...
      <div className="interview-qa-section">
       <h3 className="interview-question">Q: What’s something people don’t realize about your process or your life?</h3>
        <p id="q7" className="interview-answer">
...
It’s an all-controlling force… but it’s for your exaltation. For your destiny. For your full blossoming into what you know you came here to be. The ego wants to shortcut that, to bargain, to rationalize. But this path takes everything from the ego, sooner or later.
         ...
         <h3 className="interview-question">Q: Do you think people mistake what you do for fashion?</h3>
        <p id="q8" className="interview-answer">
...
There’s a relationship between them and the wearer… it’s symbiotic. The object permits the wearer, and the wearer consecrates the object. And the objects let you know when they’re ready to co-create with you. To live alongside you. To be shown to the world through you. Through new eyes.
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: What’s your take on performative spirituality?</h3>
        <p id="q9" className="interview-answer">
...
The vibration on this planet is getting too high for anything fake to survive. You either live in integrity… or eventually, the path will strip you of everything that isn’t true. So…beware the caftan. You might just get more than you bargained for putting that on. You’re calling in the big gunz. POW POW.
         ...
         <h3 className="interview-question">Q: What do people misunderstand about power?</h3>
        <p id="q10" className="interview-answer">
...
A lot of people don’t realize they’re even doing it. It’s unconscious. So, if you got the POWA, read between the lines. See the dynamics. Don’t let the 3D world gaslight you. Beware of the friendly. Be open to the real.
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: What’s one assumption people always make about you that’s completely wrong?</h3>
        <p id="q11" className="interview-answer">
...
My ego tucks it into my body, into my subconscious, like a secret I’m not ready to find. And you can’t really play hide and seek in the same body. There’s nowhere to go. So it leaks out in other ways.
         ...
         <h3 className="interview-question">Q: Do you ever feel like your art knows you better than you know yourself?</h3>
        <p id="q12" className="interview-answer">
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: When did you first feel like you were carrying something bigger than yourself?</h3>
        <p id="q13" className="interview-answer">
...
When I saw that, I had to make changes. If I was going to influence anyone, even one person, I wanted it to be toward freedom. True freedom. Emotional, psychological, physical, spiritual. And the only way to do that was to live it myself. And I’m always a work in progress.
        ...
        <h3 className="interview-question">Q: What’s your actual perspective on life right now? Hopeful, cynical, both?</h3>
        <p id="q14" className="interview-answer">
Always hopeful. I’ve never given up. It’s never even crossed my mind. Life is either a daring adventure or nothing at all.        
      ...
      <div className="interview-photo full-width">
       ...
       <div className="interview-qa-section">
        <h3 className="interview-question">Q: Which single choice changed your trajectory the most?</h3>
        <p id="q15" className="interview-answer">
...
This past year, when I’ve been creating all this stuff, I was laughing because I had sickness symptoms and aching knees. And I knew it’s cuz I was giving birth to something…just not the kind of baby people expect.
      ...
      <div className="interview-qa-section">
         <h3 className="interview-question">Q: If you could tell the world one sentence, and that’s all they remember of you, what would it be?</h3>
        <p id="q16" className="interview-answer">Let your life be your message.</p>  

        <h3 className="interview-question">Q: What’s the scariest thing about being seen? Or not being seen at all?</h3>
        <p id="q17" className="interview-answer">
...
But then that got flipped on its head. And it was like, light and dark. Opinion A and Opinion B. Both truths. Just a big old spectrum. Pick your vantage point. So in this chapter, I see those wounds as the medicine. My soul knows that being fully seen will force me into the deepest embodiment and integration possible in this lifetime. The arc of my life has already been written. I’m just reading my lines.
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: What’s the best gift you’ve ever received?</h3>
        <p id="q18" className="interview-answer"> Grace that opened my eyes in a way I couldn’t open them myself. You can’t force grace to find you. No drug. No person. No book. No effort. No amount of money. It’s a gift from beyond the veil and once it arrives, it changes everything. The way you see things, people, yourself, cycles, conditioning, reality. It frees you…because for the first time, you can see. It’s like, You don’t know you’re in a terrarium until you see outside it. Until then, you think it’s the whole world.
        </p>     

        <h3 className="interview-question">Q: Was there a moment when someone believing in you changed everything?</h3>
        <p id="q19" className="interview-answer">
...
Their words stuck with me. Not because I didn’t already know who I was, but because they reminded me. They reflected it back to me. In that moment, I believed it deeper.
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: What has been your greatest obsession or passion?</h3>
        <p id="q20" className="interview-answer">
...
But there is no outside world. It’s all inside. Those years taught me a lot. Now I’ve learned not to push so hard… just to listen. I still love being strong. I know I’ll be strong again. But this time… more balanced.    
        ...
        <h3 className="interview-question">Q: Would younger you be shocked at who you’ve become?</h3>
        <p id="q21" className="interview-answer">
Oh, absolutely. I’ve become her literal fantasy. I remember being seven or eight and meeting these older girls, maybe fifteen, who were just so cool. I don’t even know why but it was something about their energy. I went home and cried all night because I wanted to be their best friend. And now I realize… I am that girl. I’m my own cool best friend. I’m living the life she dreamed of, the one she never thought was possible.
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: Which object in your house accidentally explains you better than words?</h3>
        <p id="q22" className="interview-answer">
My shrunken heads.
...
Don’t cross me.
        ...
        <h3 className="interview-question">Q: How do you reconcile being fiercely independent with your longing for deep connection?</h3>
        <p id="q23" className="interview-answer">
...
People love independent thinking, until you disagree with them. Honesty until the truth is uncomfortable. Freedom until you’re not available. The mirror until it reflects them. Contradictions are hard for people to hold. They don’t really want you, just the idea of you. So, I choose the course that keeps my wings big.
      ...
      <div className="interview-qa-section">
      <h3 className="interview-question">Q: What do you mourn about the version of you that didn’t make it here?</h3>
        <p id="q24" className="interview-answer">
...
What’s better is having clear sight and then finding the warm and fuzzy in the realness. Because then it’s really real. Not wishful thinking. Not delusion.
        ...
        <h3 className="interview-question">Q: Do you think there’s something mystical about the way your path unfolded?</h3>
        <p id="q25" className="interview-answer">
I think life is mystical. And people want to figure it out. But if you just let it be mystical… it will blow your tiny mind.        
      ...
      <div className="interview-qa-section">
        <h3 className="interview-question">Q: What advice would you give, knowing most people will ignore it anyway?</h3>
        <p id="q26" className="interview-answer">
...
Just… allow. I can’t believe it took so long… to finally just begin to get that. 
    ...
    {/* 🆕 Scroll-to-top arrow */}
    <button
      className="interview-scroll-top-button"
